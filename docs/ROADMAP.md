...
| P4.iii | Pre-bake Aeon image to ECR (`us-east-1`) from the same feature-branch SHA used on DOKS | Awaits user-driven Session B ECR bake (P4.i infrastructure shipped 2026-04-19; image bake itself is operator action, not a code gate) | ⏳ pending |
